...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      increment: (...args_1) => {
        if (args_1.length !== 3) {
          throw new __compactRuntime.CompactError(`increment: expected 3 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const publicDelta_0 = args_1[1];
        const secretCap_0 = args_1[2];
        ...
        if (!(typeof(publicDelta_0) === 'bigint' && publicDelta_0 >= 0n && publicDelta_0 <= 65535n)) {
          __compactRuntime.typeError('increment',
        ...
        if (!(typeof(secretCap_0) === 'bigint' && secretCap_0 >= 0n && secretCap_0 <= 65535n)) {
          __compactRuntime.typeError('increment',
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(publicDelta_0).concat(_descriptor_0.toValue(secretCap_0)),
  ...
  _increment_0(context, partialProofData, publicDelta_0, secretCap_0) {
    __compactRuntime.assert(publicDelta_0 <= secretCap_0,
                            'public delta exceeds the secret cap');
    const delta_0 = publicDelta_0;
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { idx: { cached: false,
                                      ...
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_7.toValue(1n),
                                                                                              alignment: _descriptor_7.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(delta_0),
                                                                                              alignment: _descriptor_0.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    return [];
  }
